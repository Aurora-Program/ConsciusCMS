...
export function PaginaEjemploARC() {
  return (
    <div className="debug-arc">
      ...
      {/* EJEMPLO 3: Comparación Sin/Con ARC */}
      <section style={{ padding: '4rem 0' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 2rem' }}>
          ...
          >
            Comparación: Antes vs. Sistema ARC
          </EspiralTitulo>
...
/* 50+ more classes... */`}
            ...
            <div style={{ 
              ...
              <h3 style={{ color: '#2f855a', marginTop: '0' }}>✅ DESPUÉS (Sistema ARC)</h3>
              <pre style={{ 
                background: '#ffffff', 
                padding: '1rem', 
                borderRadius: '6px',
...
export default PaginaEjemploARC;
